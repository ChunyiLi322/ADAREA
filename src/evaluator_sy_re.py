...
class Evaluator:
    ...
    def evaluate(self):
        ...
        for data_index in range(0,16): 
            ...
            log = open("\log_"+str_file+"_new_sy_rep.txt", mode = "a+", encoding = "utf-8") 
            data_k=[]
            ...
            for word_candidate, word_candidate_index in zip(word_candidate_list, range(0,len(word_candidate_list))):                  
                log_record = open("\log_record_"+str_file+"_baseline.txt", mode = "a+", encoding = "utf-8")
                ...
                for index in range(0,30):
                    ...
                    print("目前对抗样本",record_data_need_rep, file = log)  
                    log.close()
                    log = open("\log_"+str_file+"_new_sy_rep.txt", mode = "a+", encoding = "utf-8")
                    data_m=[]
