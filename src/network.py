...
class Network(Module):
    ...
    def forward(self, inputs):
        a = inputs['text1']
        b = inputs['text2']
        # print("-------------------------打印embedding_a_org内容---------------------------------")
        # print(a[1])
        # print("-------------------------打印embedding_b_org内容---------------------------------")
        # print(b[1])
        mask_a = inputs['mask1']
        mask_b = inputs['mask2']
        # print("-------------------------打印mask_a内容---------------------------------")
        # print(mask_a[1])
        # print("-------------------------打印embedding_mask_b内容---------------------------------")
        # print(mask_b[1])
        a = self.embedding(a)
        # print("-------------------------打印embedding_a内容---------------------------------")
        # print(a.size())
        b = self.embedding(b)
        # print("-------------------------打印embedding_b内容---------------------------------")
        # print(b.size())
        res_a, res_b = a, b
        # print("-------------------------打印embedding_c内容---------------------------------")
        # print(mask_a.size())
        # print("-------------------------打印embedding_d内容---------------------------------")
        # print(mask_b.size())
