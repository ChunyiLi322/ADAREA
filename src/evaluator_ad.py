...
class Evaluator:
    ...
    def evaluate(self):
        ...
        #
        #
        # for data_index in range(0,13): 
        #     log_record = open("\log_record_wk_new.txt", mode = "a+", encoding = "utf-8")
        #     # data_index = 1     
        #     args = checkpoint['args']
        #     interface = Interface(args)
        #
        #     output_dir = '/home/lcy/adarea/simplepytorch/models/wikiqa'
        #     embedding_file = os.path.join(output_dir, 'embedding.msgpack')
        #     word_file = os.path.join(output_dir, 'vocab.txt')
        #
        #     for i in track(range(2), description='embedding load...'):
        ...
        #
        #         print("搜索空间的步数为",Positive_search_space_count, file = log_record)    
        #
        #         if exit_flag == True:
        #             break
        #
        ...
        #
        #         prior_data_loss = current_loss
        #         print("搜索空间的步数为",Negtive_search_space_count, file = log_record)    
        #
        #         if exit_flag == True:
        #             break    
        #
        #     log_record.close()    
        #     log = open("\log_wk_new.txt", mode = "a+", encoding = "utf-8")   
